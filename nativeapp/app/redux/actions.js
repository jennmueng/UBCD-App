...
export const fetchPlaces = (filter, scrollLevel) => {
    return dispatch => {
        ...
        return axios.get('http://192.168.0.101:8850/api/pe-content', filter, scrollLevel)
        .then((res) => {
...
export const fetchPlace = (id) => {
    return dispatch => {
        ...
        return axios.get('http://192.168.0.101:8850/api/pe-place', id)
        .then((res) => {
...
export const fetchImage = (src) => {
    return dispatch => {
        ...
        return axios.get('http://192.168.0.101:8850/api/get-image', src)
        .then((res) => {
